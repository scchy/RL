...
|[ HalfCheetah-v4 ](state: (17,),action: (6,)(连续 <-1.0 -> 1.0>))| PPO | Actor[256, 256];Critic[256, 256] | `seed=42` | `dict(actor_lr=5e-4,critic_lr=1e-3,gamma=0.98,PPO_kwargs={'lmbda': 0.9, 'eps': 0.2, 'k_epochs': 10, 'sgd_batch_size': 128, 'minibatch_size': 12, 'actor_nums': 3, 'actor_bound': 1})`|`dict(num_episode=10000, off_buffer_size=102400, sample_size=128, max_episode_steps=500)` | 环境相对还好稍微增Actor和Critic的网络宽度，减少`minibatch_size` |
